...
$time = time();
$status = 'pending';
$sql = "INSERT INTO forgotpassword (user_id, validkey, time, status) VALUES ('$user_id','$key','$time','$status')";
$result = mysqli_query($link, $sql);
if(!$result){
...
$message .= "http://localhost/xampp/onlineNotesApp/resetpassword.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:' . 'icv852@gmail.com')){
